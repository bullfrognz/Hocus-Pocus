...
// Member Functions
	...
	override public bool Cast(Vector3 _vTargetPoint)
	{
		...
		Network.Instantiate(Resources.Load("Prefabs/Fireball", typeof(GameObject)), transform.FindChild("TheWizard").transform.position, Quaternion.LookRotation(TempLook), 0);
