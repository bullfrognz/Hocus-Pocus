...
public class CSpellTether : CSpell
{
...
// Member Functions
	...
	override public bool Cast(Vector3 _vTargetPoint)
	{
		...
		Network.Instantiate(Resources.Load("Prefabs/Tether", typeof(GameObject)), transform.FindChild("TheWizard").transform.position, Quaternion.LookRotation(TempLook), 0);		
